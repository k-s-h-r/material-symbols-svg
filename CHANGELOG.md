...
### Changed
- Sync upstream Material Symbols from `0.47.0` to `0.47.4`.

### Added
- Icons: `car_seat_off`, `device_swoosh_star`, `mobile_tap`, `people_size_decrease`, `people_size_increase`, `spatial_gallery`, `speaker_3`, `steering_wheel_cool`, `target_check`

### Changed
- Updated icons: `battery_android_0`, `car_defrost_left`, `car_defrost_low_left`, `car_defrost_low_right`, `car_defrost_mid_left`, `car_defrost_mid_low_left`, `car_defrost_mid_low_right`, `car_defrost_mid_right`, `car_defrost_right`, `forward_to_inbox`, `grocery`, `hvac_max_defrost`, `windshield_defrost_auto`, `windshield_heat_front`
...
<!-- weekly-icon-update:start -->
### Changed
- Sync upstream Material Symbols from `0.45.2` to `0.45.5`.

### Added
- Icons: `dropdown_menu`, `eyeglasses_3`, `reset_colors`, `seat_window`, `settings_screen`, `snail`
...
<!-- weekly-icon-update:start -->
### Changed
- Sync upstream Material Symbols from `0.45.1` to `0.45.2`.

### Added
- Icons: `sign_language_off`
...
<!-- weekly-icon-update:start -->
### Changed
- Sync upstream Material Symbols from `0.44.9` to `0.44.12`.

### Added
- Icons: `audio_capture`, `car_spark`, `credit_card_spark`, `flight_spark`, `light_mode_auto`, `local_shipping_spark`, `mail_spark`, `passport_spark`, `screen_spark_pause`, `split_scene_2`, `walk_bike`, `workspace_studio`
...
<!-- weekly-icon-update:start -->
### Changed
- Sync upstream Material Symbols from `0.44.8` to `0.44.9`.

### Changed
- Updated icons: `add_task`, `add_to_drive`, `docs`, `drive_export`, `forms_add_on`, `forms_apps_script`, `task_alt`
...
[0.8.0]: https://github.com/k-s-h-r/material-symbols-svg/compare/v0.7.0...v0.8.0
