 ...
 */
export const ${componentName}W${w} = createMaterialIcon('${componentName}W${w}', pathData.regular[${w}]);`
  ).join('\n\n');
 ...
 */
export const ${filledComponentName}W${w} = createMaterialIcon('${filledComponentName}W${w}', pathData.${dataKey}[${w}]);`;
  }).join('\n\n');
