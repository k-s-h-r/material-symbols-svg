import { WEIGHTS, generatePathDataString, toPascalCase } from './common.ts';
 ...
 */
export function generateIconFileContent(iconName, style, paths, isIdentical, options: TemplateOptions = {}) {
 ...
 */
export function generateExportFileContent(iconFiles, weight, options: TemplateOptions = {}) {
