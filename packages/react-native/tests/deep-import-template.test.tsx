...
import { generateIconFileContent } from '../../../scripts/templates/react-native-template.ts';
...
describe('react-native deep import aliases', () => {
  it('exports W400 aliases', () => {
    const content = generateIconFileContent('home', 'outlined', samplePaths, false, {
      ...
      typeExportPath: '../createMaterialIcon',
    });
