...
import { generateIconFileContent } from '../../../scripts/templates/react-template.ts';
...
describe('react deep import aliases', () => {
  it('exports W400 aliases alongside explicit weight exports', () => {
    ...
    expect(content).toContain('export const HomeW400 =');
    expect(content).toContain('export const HomeFillW400 =');
